...
func NewI3() (I3, error) {
	return &impl3{}, fmt.Errorf("case: new return non nil error")
}
...
//lint:ignore ST1008 we want this to check the ioc init object with unnormal provider
...
func TestInject(t *testing.T) {
	// 新建ioc
	ioc := NewIoc(&IocOption{
		EnableUnexportedFieldSetValue: false,
		Print:                         true,
	})
